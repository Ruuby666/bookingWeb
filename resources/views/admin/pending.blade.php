        ...
        <table class="pending-reservations-table"> 
            ...
            <tbody>
                ...
                <tr class="pending-row"> 
                    ...
                    <td class="pending-checkin">{{ \Carbon\Carbon::parse($reservation->check_in)->format('d/m/Y') }}</td>
                    <td class="pending-checkout">{{ \Carbon\Carbon::parse($reservation->check_out)->format('d/m/Y') }}</td>
